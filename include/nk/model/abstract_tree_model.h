...
struct TreeIndex {
    ...
    [[nodiscard]] bool is_valid() const {
        return internal_pointer != nullptr || internal_id != 0;
    }

    [[nodiscard]] bool operator==(const TreeIndex& other) const = default;
};

/// Abstract base for arbitrary tree data models. Provides data for TreeView
/// and similar hierarchical widgets without forcing the toolkit to own the data.
///
...
public:
    ...
    [[nodiscard]] virtual std::size_t children_count(const TreeIndex& parent = TreeIndex{}) const = 0;
