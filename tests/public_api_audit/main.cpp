...
void force_symbol_references() {
    ...
    (void)static_cast<void (nk::Accessible::*)(nk::AccessibleAction, std::function<bool()>)>(
        &nk::Accessible::add_action);
    (void)static_cast<void (nk::Accessible::*)(nk::AccessibleAction)>(
        &nk::Accessible::remove_action);
    (void)static_cast<bool (nk::Accessible::*)(nk::AccessibleAction) const>(
        &nk::Accessible::supports_action);
    (void)static_cast<std::span<const nk::AccessibleAction> (nk::Accessible::*)() const>(
        &nk::Accessible::actions);
    (void)static_cast<bool (nk::Accessible::*)(nk::AccessibleAction) const>(
        &nk::Accessible::perform_action);
    (void)static_cast<void (nk::Accessible::*)(nk::AccessibleRelationKind, std::string)>(
        &nk::Accessible::set_relation);
    (void)static_cast<void (nk::Accessible::*)(nk::AccessibleRelationKind)>(
        &nk::Accessible::remove_relation);
    (void)static_cast<std::span<const nk::AccessibleRelation> (nk::Accessible::*)() const>(
        &nk::Accessible::relations);
    ...
    (void)static_cast<void (nk::ActionGroup::*)(std::shared_ptr<nk::Action>)>(
        &nk::ActionGroup::add);
    (void)static_cast<nk::Action* (nk::ActionGroup::*)(std::string_view) const>(
        &nk::ActionGroup::lookup);
    ...
    (void)static_cast<nk::Signal<float, float>& (nk::PointerController::*)()>(
        &nk::PointerController::on_enter);
    (void)static_cast<nk::Signal<>& (nk::PointerController::*)()>(&nk::PointerController::on_leave);
    (void)static_cast<nk::Signal<float, float>& (nk::PointerController::*)()>(
        &nk::PointerController::on_motion);
    (void)static_cast<nk::Signal<float, float, int>& (nk::PointerController::*)()>(
        &nk::PointerController::on_pressed);
    (void)static_cast<nk::Signal<float, float, int>& (nk::PointerController::*)()>(
        &nk::PointerController::on_released);
    (void)static_cast<nk::Signal<int, int>& (nk::KeyboardController::*)()>(
        &nk::KeyboardController::on_key_pressed);
    (void)static_cast<nk::Signal<int, int>& (nk::KeyboardController::*)()>(
        &nk::KeyboardController::on_key_released);
    ...
    (void)static_cast<nk::ScopedConnection& (nk::ScopedConnection::*)(nk::ScopedConnection&&)>(
        &nk::ScopedConnection::operator=);
    ...
    (void)static_cast<nk::SizeRequest (nk::BoxLayout::*)(const nk::Widget&, const nk::Constraints&)
    ...
    (void)static_cast<void (nk::GridLayout::*)(nk::Widget&, int, int, int, int)>(
        &nk::GridLayout::attach);
    ...
    (void)static_cast<nk::SizeRequest (nk::GridLayout::*)(const nk::Widget&, const nk::Constraints&)
                          const>(&nk::GridLayout::measure);
    (void)static_cast<void (nk::GridLayout::*)(nk::Widget&, const nk::Rect&)>(
        &nk::GridLayout::allocate);
    (void)static_cast<nk::SizeRequest (nk::StackLayout::*)(
        const nk::Widget&, const nk::Constraints&) const>(&nk::StackLayout::measure);
    (void)static_cast<void (nk::StackLayout::*)(nk::Widget&, const nk::Rect&)>(
        &nk::StackLayout::allocate);
    (void)static_cast<std::string (nk::AbstractListModel::*)(std::size_t) const>(
        &nk::AbstractListModel::display_text);
    (void)static_cast<nk::Signal<std::size_t, std::size_t>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_rows_about_to_insert);
    (void)static_cast<nk::Signal<std::size_t, std::size_t>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_rows_inserted);
    (void)static_cast<nk::Signal<std::size_t, std::size_t>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_rows_about_to_remove);
    (void)static_cast<nk::Signal<std::size_t, std::size_t>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_rows_removed);
    (void)static_cast<nk::Signal<std::size_t, std::size_t>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_data_changed);
    (void)static_cast<nk::Signal<>& (nk::AbstractListModel::*)()>(
        &nk::AbstractListModel::on_model_reset);
    // REMOVED (protected member, caught by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)(std::size_t,
    // std::size_t)>(&nk::AbstractListModel::begin_insert_rows); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)()>(&nk::AbstractListModel::end_insert_rows); REMOVED (protected
    // member, caught by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)(std::size_t,
    // std::size_t)>(&nk::AbstractListModel::begin_remove_rows); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)()>(&nk::AbstractListModel::end_remove_rows); REMOVED (protected
    // member, caught by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)(std::size_t,
    // std::size_t)>(&nk::AbstractListModel::notify_data_changed); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void
    // (nk::AbstractListModel::*)()>(&nk::AbstractListModel::notify_model_reset);
    (void)static_cast<std::size_t (nk::StringListModel::*)() const>(
        &nk::StringListModel::row_count);
    (void)static_cast<std::any (nk::StringListModel::*)(std::size_t) const>(
        &nk::StringListModel::data);
    (void)static_cast<std::string (nk::StringListModel::*)(std::size_t) const>(
        &nk::StringListModel::display_text);
    (void)static_cast<void (nk::StringListModel::*)(std::string)>(&nk::StringListModel::append);
    (void)static_cast<void (nk::StringListModel::*)(std::size_t, std::string)>(
        &nk::StringListModel::insert);
    ...
    (void)static_cast<bool (nk::SelectionModel::*)(std::size_t) const>(
        &nk::SelectionModel::is_selected);
    (void)static_cast<const std::set<std::size_t>& (nk::SelectionModel::*)() const>(
        &nk::SelectionModel::selected_rows);
    (void)static_cast<std::size_t (nk::SelectionModel::*)() const>(
        &nk::SelectionModel::current_row);
    (void)static_cast<void (nk::SelectionModel::*)(std::size_t)>(
        &nk::SelectionModel::set_current_row);
    (void)static_cast<nk::Signal<>& (nk::SelectionModel::*)()>(
    ...
    (void)static_cast<const nk::SystemPreferences& (nk::Application::*)() const>(
        &nk::Application::system_preferences);
    (void)static_cast<void (nk::Application::*)()>(&nk::Application::refresh_system_preferences);
    (void)static_cast<const nk::ThemeSelection& (nk::Application::*)() const>(
        &nk::Application::theme_selection);
    (void)static_cast<void (nk::Application::*)(nk::ThemeSelection)>(
        &nk::Application::set_theme_selection);
    (void)static_cast<void (nk::Application::*)(bool)>(
        &nk::Application::set_system_preferences_observation_enabled);
    (void)static_cast<bool (nk::Application::*)() const>(
        &nk::Application::is_system_preferences_observation_enabled);
    (void)static_cast<void (nk::Application::*)(std::chrono::milliseconds)>(
        &nk::Application::set_system_preferences_observation_interval);
    (void)static_cast<std::chrono::milliseconds (nk::Application::*)() const>(
        &nk::Application::system_preferences_observation_interval);
    (void)&nk::Application::instance;
    (void)static_cast<bool (nk::Application::*)() const>(&nk::Application::has_platform_backend);
    (void)static_cast<nk::PlatformBackend& (nk::Application::*)()>(
        &nk::Application::platform_backend);
    (void)static_cast<bool (nk::Application::*)() const>(
        &nk::Application::supports_open_file_dialog);
    (void)static_cast<nk::OpenFileDialogResult (nk::Application::*)(
        std::string_view, const std::vector<std::string>&)>(&nk::Application::open_file_dialog);
    ...
    (void)static_cast<bool (nk::Application::*)() const>(
        &nk::Application::supports_primary_selection_text);
    (void)static_cast<std::string (nk::Application::*)() const>(
        &nk::Application::primary_selection_text);
    (void)static_cast<void (nk::Application::*)(std::string)>(
        &nk::Application::set_primary_selection_text);
    (void)static_cast<bool (nk::Application::*)() const>(
        &nk::Application::supports_native_app_menu);
    (void)static_cast<void (nk::Application::*)(std::vector<nk::NativeMenu>)>(
        &nk::Application::set_native_app_menu);
    (void)static_cast<nk::Signal<const nk::SystemPreferences&>& (nk::Application::*)()>(
        &nk::Application::on_system_preferences_changed);
    (void)static_cast<nk::Signal<const nk::ThemeSelection&>& (nk::Application::*)()>(
    ...
    (void)static_cast<void (nk::NativeSurface::*)(
    ...
    (void)static_cast<void (nk::NativeSurface::*)(nk::CursorShape)>(
        &nk::NativeSurface::set_cursor_shape);
    (void)static_cast<nk::Result<void> (nk::PlatformBackend::*)()>(
        &nk::PlatformBackend::initialize);
    (void)static_cast<void (nk::PlatformBackend::*)()>(&nk::PlatformBackend::shutdown);
    (void)static_cast<std::unique_ptr<nk::NativeSurface> (nk::PlatformBackend::*)(
        const nk::WindowConfig&, nk::Window&)>(&nk::PlatformBackend::create_surface);
    (void)static_cast<int (nk::PlatformBackend::*)(nk::EventLoop&)>(
    ...
    (void)static_cast<nk::OpenFileDialogResult (nk::PlatformBackend::*)(
        std::string_view, const std::vector<std::string>&)>(
        &nk::PlatformBackend::show_open_file_dialog);
    ...
    (void)static_cast<void (nk::Window::*)(const nk::MouseEvent&)>(
        &nk::Window::dispatch_mouse_event);
    (void)static_cast<void (nk::Window::*)(const nk::KeyEvent&)>(&nk::Window::dispatch_key_event);
    (void)static_cast<void (nk::Window::*)(const nk::TextInputEvent&)>(
    ...
    (void)static_cast<std::optional<nk::Rect> (nk::Window::*)() const>(
    ...
    (void)static_cast<void (nk::Window::*)(nk::DebugOverlayFlags)>(
        &nk::Window::set_debug_overlay_flags);
    (void)static_cast<nk::DebugOverlayFlags (nk::Window::*)() const>(
        &nk::Window::debug_overlay_flags);
    (void)static_cast<void (nk::Window::*)(nk::DebugInspectorPresentation)>(
        &nk::Window::set_debug_inspector_presentation);
    (void)static_cast<nk::DebugInspectorPresentation (nk::Window::*)() const>(
        &nk::Window::debug_inspector_presentation);
    (void)static_cast<const nk::FrameDiagnostics& (nk::Window::*)() const>(
        &nk::Window::last_frame_diagnostics);
    (void)static_cast<std::span<const nk::FrameDiagnostics> (nk::Window::*)() const>(
        &nk::Window::debug_frame_history);
    ...
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_widget_tree_json_file);
    (void)static_cast<std::string (nk::Window::*)() const>(&nk::Window::dump_frame_trace_json);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_frame_diagnostics_artifact_json_file);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_frame_trace_json_file);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_debug_bundle);
    (void)static_cast<std::vector<nk::TraceEvent> (nk::Window::*)() const>(
        &nk::Window::debug_selected_frame_runtime_events);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_frame_summary);
    (void)static_cast<nk::Result<void> (nk::Window::*)() const>(
        &nk::Window::copy_selected_frame_summary_to_clipboard);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_selected_frame_summary_file);
    (void)static_cast<nk::RenderSnapshotNode (nk::Window::*)() const>(
        &nk::Window::debug_selected_frame_render_snapshot);
    (void)static_cast<nk::RenderSnapshotNode (nk::Window::*)() const>(
        &nk::Window::debug_selected_render_node);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_frame_render_snapshot);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_frame_render_snapshot_json);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_render_node_details);
    (void)static_cast<nk::Result<void> (nk::Window::*)() const>(
        &nk::Window::copy_selected_render_node_details_to_clipboard);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_selected_render_node_details_file);
    ...
    (void)static_cast<nk::WidgetDebugNode (nk::Window::*)() const>(
        &nk::Window::debug_selected_widget_info);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_widget_details);
    (void)static_cast<std::string (nk::Window::*)() const>(
        &nk::Window::dump_selected_widget_details_json);
    (void)static_cast<nk::Result<void> (nk::Window::*)() const>(
        &nk::Window::copy_selected_widget_details_to_clipboard);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_selected_widget_details_file);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_selected_widget_details_json_file);
    (void)static_cast<nk::Result<void> (nk::Window::*)(std::string_view) const>(
        &nk::Window::save_debug_screenshot_ppm_file);
    ...
    (void)static_cast<void (nk::RenderNode::*)(std::string, std::span<const std::size_t>)>(
        &nk::RenderNode::set_debug_source);
    (void)static_cast<std::string_view (nk::RenderNode::*)() const>(
        &nk::RenderNode::debug_source_label);
    (void)static_cast<std::span<const std::size_t> (nk::RenderNode::*)() const>(
        &nk::RenderNode::debug_source_path);
    (void)static_cast<void (nk::RenderNode::*)(std::unique_ptr<nk::RenderNode>)>(
        &nk::RenderNode::append_child);
    (void)static_cast<const std::vector<std::unique_ptr<nk::RenderNode>>& (nk::RenderNode::*)()
                          const>(&nk::RenderNode::children);
    ...
    (void)static_cast<void (nk::Renderer::*)(std::span<const nk::Rect>)>(
        &nk::Renderer::set_damage_regions);
    (void)static_cast<nk::RenderHotspotCounters (nk::Renderer::*)() const>(
        &nk::Renderer::last_hotspot_counters);
    (void)static_cast<const uint8_t* (nk::SoftwareRenderer::*)() const>(
        &nk::SoftwareRenderer::pixel_data);
    ...
    (void)static_cast<void (nk::SnapshotContext::*)(std::unique_ptr<nk::RenderNode>)>(
        &nk::SnapshotContext::add_node);
    (void)static_cast<void (nk::SnapshotContext::*)(nk::Rect, nk::Color)>(
        &nk::SnapshotContext::add_color_rect);
    (void)static_cast<void (nk::SnapshotContext::*)(nk::Rect, nk::Color, float)>(
        &nk::SnapshotContext::add_rounded_rect);
    (void)static_cast<void (nk::SnapshotContext::*)(nk::Rect, nk::Color, float, float)>(
        &nk::SnapshotContext::add_border);
    ...
    (void)static_cast<bool (nk::SnapshotContext::*)() const>(
        &nk::SnapshotContext::debug_annotations_enabled);
    (void)static_cast<void (nk::SnapshotContext::*)(std::string, std::span<const std::size_t>)>(
        &nk::SnapshotContext::push_debug_source);
    (void)static_cast<void (nk::SnapshotContext::*)()>(&nk::SnapshotContext::pop_debug_source);
    (void)static_cast<void (nk::SnapshotContext::*)(nk::Rect, float)>(
        &nk::SnapshotContext::push_rounded_clip);
    (void)static_cast<void (nk::SnapshotContext::*)(nk::Rect)>(
        &nk::SnapshotContext::push_overlay_container);
    (void)static_cast<void (nk::SnapshotContext::*)()>(&nk::SnapshotContext::pop_container);
    (void)static_cast<std::unique_ptr<nk::RenderNode> (nk::SnapshotContext::*)()>(
        &nk::SnapshotContext::take_root);
    (void)static_cast<int (nk::EventLoop::*)()>(&nk::EventLoop::run);
    (void)static_cast<void (nk::EventLoop::*)(int)>(&nk::EventLoop::quit);
    (void)static_cast<void (nk::EventLoop::*)(std::function<void()>, std::string_view)>(
        &nk::EventLoop::post);
    (void)static_cast<nk::CallbackHandle (nk::EventLoop::*)(
        std::chrono::milliseconds, std::function<void()>, std::string_view)>(
        &nk::EventLoop::set_timeout);
    (void)static_cast<nk::CallbackHandle (nk::EventLoop::*)(
        std::chrono::milliseconds, std::function<void()>, std::string_view)>(
        &nk::EventLoop::set_interval);
    (void)static_cast<void (nk::EventLoop::*)(nk::CallbackHandle)>(&nk::EventLoop::cancel);
    (void)static_cast<nk::CallbackHandle (nk::EventLoop::*)(
        std::function<void()>, std::string_view)>(&nk::EventLoop::add_idle);
    ...
    (void)static_cast<std::span<const nk::TraceEvent> (nk::EventLoop::*)() const>(
        &nk::EventLoop::debug_trace_events);
    ...
    (void)static_cast<const nk::StyleValue* (nk::Theme::*)(std::string_view) const>(
        &nk::Theme::token);
    ...
    (void)static_cast<nk::ShapedText& (nk::ShapedText::*)(nk::ShapedText&&)>(
        &nk::ShapedText::operator=);
    ...
    (void)static_cast<const uint8_t* (nk::ShapedText::*)() const>(&nk::ShapedText::bitmap_data);
    ...
    (void)static_cast<void (nk::ShapedText::*)(std::vector<uint8_t>, int, int)>(
        &nk::ShapedText::set_bitmap);
    (void)&nk::TextShaper::create;
    (void)static_cast<nk::Widget* (nk::Widget::*)() const>(&nk::Widget::parent);
    (void)static_cast<std::span<const std::shared_ptr<nk::Widget>> (nk::Widget::*)() const>(
        &nk::Widget::children);
    ...
    (void)static_cast<std::span<const std::string> (nk::Widget::*)() const>(
        &nk::Widget::style_classes);
    ...
    (void)static_cast<nk::SizeRequest (nk::Widget::*)(const nk::Constraints&) const>(
        &nk::Widget::measure);
    (void)static_cast<nk::SizeRequest (nk::Widget::*)(const nk::Constraints&) const>(
        &nk::Widget::measure_for_diagnostics);
    ...
    (void)static_cast<void (nk::Widget::*)(std::unique_ptr<nk::LayoutManager>)>(
        &nk::Widget::set_layout_manager);
    ...
    (void)static_cast<void (nk::Widget::*)(nk::SizePolicy)>(
        &nk::Widget::set_horizontal_size_policy);
    ...
    (void)static_cast<nk::Color (nk::LinearGradientNode::*)() const>(
        &nk::LinearGradientNode::start_color);
    (void)static_cast<nk::Color (nk::LinearGradientNode::*)() const>(
        &nk::LinearGradientNode::end_color);
    (void)static_cast<nk::Orientation (nk::LinearGradientNode::*)() const>(
        &nk::LinearGradientNode::direction);
    ...
    (void)static_cast<nk::WidgetHotspotCounters (nk::Widget::*)() const>(
        &nk::Widget::debug_hotspot_counters);
    ...
    (void)static_cast<nk::Constraints (nk::Widget::*)() const>(
        &nk::Widget::debug_last_measure_constraints);
    (void)static_cast<nk::SizeRequest (nk::Widget::*)() const>(
        &nk::Widget::debug_last_size_request);
    (void)static_cast<std::vector<nk::Rect> (nk::Widget::*)() const>(
        &nk::Widget::debug_damage_regions);
    (void)static_cast<std::span<const nk::Rect> (nk::Widget::*)() const>(
        &nk::Widget::debug_preserved_damage_regions);
    ...
    (void)static_cast<void (nk::Widget::*)(std::shared_ptr<nk::EventController>)>(
        &nk::Widget::add_controller);
    ...
    // REMOVED (protected member, caught by audit iteration): (void)static_cast<nk::Color
    // (nk::Widget::*)(std::string_view, nk::Color) const>(&nk::Widget::theme_color); REMOVED
    // (protected member, caught by audit iteration): (void)static_cast<float
    // (nk::Widget::*)(std::string_view, float) const>(&nk::Widget::theme_number); REMOVED
    // (protected member, caught by audit iteration): (void)static_cast<nk::Size
    // (nk::Widget::*)(std::string_view, const nk::FontDescriptor&)
    // const>(&nk::Widget::measure_text); REMOVED (protected member, caught by audit iteration):
    // (void)static_cast<void (nk::Widget::*)()
    // const>(&nk::Widget::note_text_measure_for_diagnostics); REMOVED (protected member, caught by
    // audit iteration): (void)static_cast<void (nk::Widget::*)()
    // const>(&nk::Widget::note_image_snapshot_for_diagnostics); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void (nk::Widget::*)(std::size_t, std::size_t,
    // std::size_t) const>(&nk::Widget::note_model_view_sync_for_diagnostics); REMOVED (protected
    // member, caught by audit iteration): (void)static_cast<void
    // (nk::Widget::*)()>(&nk::Widget::preserve_damage_regions_for_next_redraw); REMOVED (protected
    // member, caught by audit iteration): (void)static_cast<void
    // (nk::Widget::*)(std::shared_ptr<nk::Widget>)>(&nk::Widget::append_child); REMOVED (protected
    // member, caught by audit iteration): (void)static_cast<void (nk::Widget::*)(std::size_t,
    // std::shared_ptr<nk::Widget>)>(&nk::Widget::insert_child); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void
    // (nk::Widget::*)(nk::Widget&)>(&nk::Widget::remove_child); REMOVED (protected member, caught
    // by audit iteration): (void)static_cast<void (nk::Widget::*)()>(&nk::Widget::clear_children);
    ...
    (void)static_cast<nk::SizeRequest (nk::Button::*)(const nk::Constraints&) const>(
        &nk::Button::measure);
    ...
    (void)static_cast<nk::SizeRequest (nk::ComboBox::*)(const nk::Constraints&) const>(
        &nk::ComboBox::measure);
    (void)static_cast<bool (nk::ComboBox::*)(const nk::MouseEvent&)>(
        &nk::ComboBox::handle_mouse_event);
    ...
    (void)static_cast<std::vector<nk::Rect> (nk::ComboBox::*)() const>(
        &nk::ComboBox::damage_regions);
    ...
    (void)static_cast<void (nk::Dialog::*)(std::string, nk::DialogResponse)>(
        &nk::Dialog::add_button);
    (void)static_cast<void (nk::Dialog::*)(std::shared_ptr<nk::Widget>)>(&nk::Dialog::set_content);
    (void)static_cast<void (nk::Dialog::*)(nk::DialogPresentationStyle)>(
        &nk::Dialog::set_presentation_style);
    ...
    (void)static_cast<nk::SizeRequest (nk::Dialog::*)(const nk::Constraints&) const>(
        &nk::Dialog::measure);
    ...
    (void)static_cast<void (nk::ImageView::*)(const uint32_t*, int, int)>(
        &nk::ImageView::update_pixel_buffer);
    ...
    (void)static_cast<nk::SizeRequest (nk::ImageView::*)(const nk::Constraints&) const>(
        &nk::ImageView::measure);
    ...
    (void)static_cast<nk::SizeRequest (nk::Label::*)(const nk::Constraints&) const>(
        &nk::Label::measure);
    (void)&nk::ListView::create;
    (void)static_cast<void (nk::ListView::*)(std::shared_ptr<nk::AbstractListModel>)>(
        &nk::ListView::set_model);
    (void)static_cast<nk::AbstractListModel* (nk::ListView::*)() const>(&nk::ListView::model);
    (void)static_cast<void (nk::ListView::*)(std::shared_ptr<nk::SelectionModel>)>(
        &nk::ListView::set_selection_model);
    (void)static_cast<nk::SelectionModel* (nk::ListView::*)() const>(
        &nk::ListView::selection_model);
    ...
    (void)static_cast<nk::Signal<std::size_t>& (nk::ListView::*)()>(
        &nk::ListView::on_row_activated);
    (void)static_cast<nk::SizeRequest (nk::ListView::*)(const nk::Constraints&) const>(
        &nk::ListView::measure);
    (void)static_cast<void (nk::ListView::*)(const nk::Rect&)>(&nk::ListView::allocate);
    (void)static_cast<bool (nk::ListView::*)(const nk::MouseEvent&)>(
        &nk::ListView::handle_mouse_event);
    ...
    (void)static_cast<nk::SizeRequest (nk::MenuBar::*)(const nk::Constraints&) const>(
        &nk::MenuBar::measure);
    (void)static_cast<bool (nk::MenuBar::*)(const nk::MouseEvent&)>(
        &nk::MenuBar::handle_mouse_event);
    ...
    (void)static_cast<void (nk::ScrollArea::*)(std::shared_ptr<nk::Widget>)>(
        &nk::ScrollArea::set_content);
    (void)static_cast<nk::Widget* (nk::ScrollArea::*)() const>(&nk::ScrollArea::content);
    (void)static_cast<void (nk::ScrollArea::*)(nk::ScrollPolicy)>(
        &nk::ScrollArea::set_h_scroll_policy);
    (void)static_cast<void (nk::ScrollArea::*)(nk::ScrollPolicy)>(
        &nk::ScrollArea::set_v_scroll_policy);
    ...
    (void)static_cast<nk::Signal<float, float>& (nk::ScrollArea::*)()>(
        &nk::ScrollArea::on_scroll_changed);
    (void)static_cast<nk::SizeRequest (nk::ScrollArea::*)(const nk::Constraints&) const>(
        &nk::ScrollArea::measure);
    (void)static_cast<void (nk::ScrollArea::*)(const nk::Rect&)>(&nk::ScrollArea::allocate);
    (void)static_cast<bool (nk::ScrollArea::*)(const nk::MouseEvent&)>(
        &nk::ScrollArea::handle_mouse_event);
    (void)&nk::SegmentedControl::create;
    (void)static_cast<void (nk::SegmentedControl::*)(std::vector<std::string>)>(
        &nk::SegmentedControl::set_segments);
    (void)static_cast<std::size_t (nk::SegmentedControl::*)() const>(
        &nk::SegmentedControl::segment_count);
    (void)static_cast<std::string_view (nk::SegmentedControl::*)(std::size_t) const>(
        &nk::SegmentedControl::segment);
    (void)static_cast<int (nk::SegmentedControl::*)() const>(&nk::SegmentedControl::selected_index);
    (void)static_cast<void (nk::SegmentedControl::*)(int)>(
        &nk::SegmentedControl::set_selected_index);
    (void)static_cast<std::string_view (nk::SegmentedControl::*)() const>(
        &nk::SegmentedControl::selected_text);
    (void)static_cast<nk::Signal<int>& (nk::SegmentedControl::*)()>(
        &nk::SegmentedControl::on_selection_changed);
    (void)static_cast<nk::SizeRequest (nk::SegmentedControl::*)(const nk::Constraints&) const>(
        &nk::SegmentedControl::measure);
    (void)static_cast<bool (nk::SegmentedControl::*)(const nk::MouseEvent&)>(
        &nk::SegmentedControl::handle_mouse_event);
    (void)static_cast<bool (nk::SegmentedControl::*)(const nk::KeyEvent&)>(
        &nk::SegmentedControl::handle_key_event);
    (void)static_cast<nk::CursorShape (nk::SegmentedControl::*)() const>(
        &nk::SegmentedControl::cursor_shape);
    (void)static_cast<void (nk::SegmentedControl::*)(bool)>(
        &nk::SegmentedControl::on_focus_changed);
    (void)&nk::StatusBar::create;
    (void)static_cast<void (nk::StatusBar::*)(std::vector<std::string>)>(
        &nk::StatusBar::set_segments);
    (void)static_cast<void (nk::StatusBar::*)(std::size_t, std::string)>(
        &nk::StatusBar::set_segment);
    (void)static_cast<std::size_t (nk::StatusBar::*)() const>(&nk::StatusBar::segment_count);
    (void)static_cast<std::string_view (nk::StatusBar::*)(std::size_t) const>(
        &nk::StatusBar::segment);
    (void)static_cast<nk::SizeRequest (nk::StatusBar::*)(const nk::Constraints&) const>(
        &nk::StatusBar::measure);
    ...
    (void)static_cast<nk::SpellChecker* (nk::PlatformBackend::*)()>(
        &nk::PlatformBackend::spell_checker);
    (void)static_cast<nk::Signal<std::string_view>& (nk::TextField::*)()>(
        &nk::TextField::on_text_changed);
    (void)static_cast<nk::Signal<>& (nk::TextField::*)()>(&nk::TextField::on_activate);
    (void)static_cast<nk::SizeRequest (nk::TextField::*)(const nk::Constraints&) const>(
        &nk::TextField::measure);
    (void)static_cast<void (nk::TextField::*)(const nk::Rect&)>(&nk::TextField::allocate);
    (void)static_cast<bool (nk::TextField::*)(const nk::MouseEvent&)>(
        &nk::TextField::handle_mouse_event);
    (void)static_cast<bool (nk::TextField::*)(const nk::KeyEvent&)>(
