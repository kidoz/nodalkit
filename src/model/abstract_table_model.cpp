...
Signal<std::size_t, std::size_t>& AbstractTableModel::on_rows_about_to_insert() {
    return impl_->rows_about_to_insert;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_rows_inserted() {
    return impl_->rows_inserted;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_rows_about_to_remove() {
    return impl_->rows_about_to_remove;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_rows_removed() {
    return impl_->rows_removed;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_columns_about_to_insert() {
    return impl_->columns_about_to_insert;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_columns_inserted() {
    return impl_->columns_inserted;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_columns_about_to_remove() {
    return impl_->columns_about_to_remove;
}

Signal<std::size_t, std::size_t>& AbstractTableModel::on_columns_removed() {
    return impl_->columns_removed;
}

Signal<std::size_t, std::size_t, std::size_t, std::size_t>& AbstractTableModel::on_data_changed() {
    return impl_->data_changed;
}

Signal<>& AbstractTableModel::on_model_reset() {
...
void AbstractTableModel::notify_data_changed(std::size_t top_row,
